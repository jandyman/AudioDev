...
def wait_for_response(jlink, expected_seq, n_bytes=3):
    return rtt_read_exact(jlink, n_bytes, timeout_s=ACK_TIMEOUT_S)


def ping(jlink, seq=1):
...
def set_param(jlink, param_id, value, seq=1):
